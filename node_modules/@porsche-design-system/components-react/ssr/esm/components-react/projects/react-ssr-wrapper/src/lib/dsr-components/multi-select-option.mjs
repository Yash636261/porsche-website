...
import { getMultiSelectOptionCss as getComponentCss$A } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRMultiSelectOption extends Component {
    ...
    render() {
        ...
        minifyCss(stripFocusAndHoverStyles(getComponentCss$A(theme)));
        return (jsx(Fragment, {}));
    }
}
