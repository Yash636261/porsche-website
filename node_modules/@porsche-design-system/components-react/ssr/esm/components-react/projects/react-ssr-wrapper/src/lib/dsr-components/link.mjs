...
import { getLinkCss as getComponentCss$H } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRLink extends Component {
    ...
    render() {
        ...
        const style = minifyCss(stripFocusAndHoverStyles(getComponentCss$H(this.props.icon, this.props.iconSource, this.props.variant, this.props.hideLabel, !this.props.href, this.props.theme)));
