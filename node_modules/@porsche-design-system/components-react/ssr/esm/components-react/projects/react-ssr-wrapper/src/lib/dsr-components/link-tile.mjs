...
class DSRLinkTile extends Component {
    ...
    render() {
        ...
        const style = minifyCss(stripFocusAndHoverStyles(getComponentCss$E(this.props.aspectRatio, this.props.size, this.props.weight, // potentially breakpoint customizable, so we can't easily access the deprecation map
