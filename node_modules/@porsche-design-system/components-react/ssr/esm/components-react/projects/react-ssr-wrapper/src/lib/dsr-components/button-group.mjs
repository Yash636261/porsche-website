...
import { getButtonGroupCss as getComponentCss$13 } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';

class DSRButtonGroup extends Component {
    host;
    render() {
        splitChildren(this.props.children);
        const style = minifyCss(stripFocusAndHoverStyles(getComponentCss$13(this.props.direction)));
