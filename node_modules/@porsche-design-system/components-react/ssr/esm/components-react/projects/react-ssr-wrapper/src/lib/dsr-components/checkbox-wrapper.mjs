...
import { getCheckboxWrapperCss as getComponentCss$_ } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRCheckboxWrapper extends Component {
    ...
    render() {
        ...
        const style = minifyCss(stripFocusAndHoverStyles(getComponentCss$_(this.props.hideLabel, this.props.state, disabled, this.props.loading, this.props.theme)));
