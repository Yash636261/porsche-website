...
class DSRTag extends react.Component {
    ...
    render() {
        ...
        const style = minifyCss.minifyCss(stripFocusAndHoverStyles.stripFocusAndHoverStyles(stylesEntry.getTagCss((deprecationMap[this.props.color] || this.props.color), !!utilsEntry.getDirectChildHTMLElement(null, 'a,button'), this.props.theme)));
        return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("template", { shadowroot: "open", shadowrootmode: "open", children: [jsxRuntime.jsx("style", { dangerouslySetInnerHTML: { __html: style } }), jsxRuntime.jsxs("span", { children: [(this.props.icon || this.props.iconSource) && (jsxRuntime.jsx(icon_wrapper.PIcon, { className: "icon", name: this.props.icon, source: this.props.iconSource, color: "primary", size: "x-small", theme: utilsEntry.getThemeForIcon(this.props.color, this.props.theme), "aria-hidden": "true" })), jsxRuntime.jsx("div", { className: "label", children: jsxRuntime.jsx("slot", {}) })] })] }), this.props.children] }));
    }
}
